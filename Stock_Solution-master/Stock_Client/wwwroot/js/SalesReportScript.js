...
var SalesReportCustom = {
    ...
    TotalCount: -1,
    Reset: function () {
        SalesReportCustom.CurrentPage = 1;
        SalesReportCustom.TotalCount = -1;
    },
    LoadSalesReportCustom: function () {
        if (SalesReportCustom.LoaderAjax && SalesReportCustom.LoaderAjax.readyState != 4) {
            return;
        }
        if (SalesReportCustom.TotalCount == $("tr.data").length) {
            return;
        }
        ...
        var paramlite = {
            ...
            EndDate: ToDateTime,
            PageNo: SalesReportCustom.CurrentPage,
        ...
        SalesReportCustom.LoaderAjax = $.ajax({
            type: "post",
            url: '/Report/SalesReportCustom',
            data: paramlite,
            cache: false,
    ...
    DownloadSalesReport: function () {
        ...
        var parm = '?StartDate=' + FromDateTime
            ...
            + '&TransactionType=' + TransactionType
            + '&IsDownload=true';
        window.location.href = "/Report/DownloadSalesReport" + parm;
    },
    SearchSalesReportCustom: function () {
        SalesReportCustom.CurrentPage = 1;
        SalesReportCustom.TotalCount = -1;
        SalesReportCustom.LoadSalesReportCustom();
    },
}
$("#Print_selected_option").click(function () {
    if ($('#PrintOption').val() == '-1') {
        ...
        SalesReportCustom.Reset()
        SalesReportCustom.Print(options)
    }
});
...
$(document).ready(function () {
    ...
    $("#PrintAllSettled").click(function () {
        SalesReportCustom.PrintAllinvoicePDF();
    });
    $("#SearchOrder").keyup(function () {
        SalesReportCustom.SearchSalesReportCustom();
    })
