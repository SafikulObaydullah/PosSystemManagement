...
var ThisWeekStartDay = moment(CurrentDate).startOf(WeekStartDay).format(DateFormat);
var ThisWeekEndDay = moment(CurrentDate).endOf(WeekStartDay).format(DateFormat);
var ThisMonthStartDay = moment(CurrentDate).startOf('month').format(DateFormat);
var ThisMonthEndDay = moment(CurrentDate).endOf('month').format(DateFormat);
var LastWeekStartDay = moment(CurrentDate).subtract(1, 'weeks').startOf(WeekStartDay).format(DateFormat);
var LastWeekEndDay = moment(CurrentDate).subtract(1, 'weeks').endOf(WeekStartDay).format(DateFormat);
var LastMonthStartDay = moment(CurrentDate).subtract(1, 'months').startOf('month').format(DateFormat);
var LastMonthEndDay = moment(CurrentDate).subtract(1, 'months').endOf('month').format(DateFormat);
...
$(document).ready(function () {
    ...
    $('#dtfilterrev').click(function () {
        $("#revdatefilter").toggleClass('display_nn');
    });
    ...
    $('#DateRangeRev').change(function () {
        ...
        if ($("#DateRangeRev").children(":selected").attr("value") == "8") {
            $('#FilterByRev').text("This Week");
            $('#ReviewFilterStartDate').val(ThisWeekStartDay);
            $('#ReviewFilterEndDate').val(ThisWeekEndDay);
        }
        if ($("#DateRangeRev").children(":selected").attr("value") == "15") {
            $('#FilterByRev').text("Last Week");
            $('#ReviewFilterStartDate').val(LastWeekStartDay);
            $('#ReviewFilterEndDate').val(LastWeekEndDay);
        }
        if ($("#DateRangeRev").children(":selected").attr("value") == "30") {
            $('#FilterByRev').text("This Month");
            $('#ReviewFilterStartDate').val(ThisMonthStartDay);
            $('#ReviewFilterEndDate').val(ThisMonthEndDay);

        }
        if ($("#DateRangeRev").children(":selected").attr("value") == "60") {
            $('#FilterByRev').text("Last Month");
            $('#ReviewFilterStartDate').val(LastMonthStartDay);
            $('#ReviewFilterEndDate').val(LastMonthEndDay);
        }
